...
public class BetterNumberBoxListEntryForge extends NumberBoxListEntry implements IBetterNumberBoxListEntry {

	public BetterNumberBoxListEntryForge(int amount, boolean decimals, Component component, Component tooltip) {
