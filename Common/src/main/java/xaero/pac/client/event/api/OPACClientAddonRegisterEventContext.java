...
/**
 * The context for the addon register event on the client side
 */
public class OPACClientAddonRegisterEventContext {
	 ...
	 * @param claimsManagerClaimResultTrackerAPI  the claims manager claim result tracker API, not null
	 */
	public OPACClientAddonRegisterEventContext(
			@Nonnull IClaimsManagerTrackerRegisterAPI claimsManagerTrackerAPI,
			@Nonnull IClaimsManagerClaimResultTrackerRegisterAPI claimsManagerClaimResultTrackerAPI
	) {
	...
	/**
	 * Gets the claims manager claim result tracker API.
	 *
	 * @return the claims manager claim result tracker API, not null
	 */
	@Nonnull
