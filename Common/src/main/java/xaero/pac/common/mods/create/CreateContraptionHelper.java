...
public class CreateContraptionHelper {
	...
	public static ResourceKey<Block> CONTRAPTION_CONTROLS_BLOCK = ResourceKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation("create", "contraption_controls"));
