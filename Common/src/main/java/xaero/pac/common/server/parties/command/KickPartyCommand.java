...
public class KickPartyCommand {
						...
						.executes(context -> {
							...
							if(targetIsMember) {
								...
								if(kickedPlayer != null) {
									...
									kickedPlayer.sendMessage(acceptComponent, player.getUUID());
								}
							}
	...
	public static Component getKickMessage(ServerPlayer callerPlayer, String targetName){
		return new TranslatableComponent(
				...
				new TextComponent(callerPlayer.getGameProfile().getName()).withStyle(s -> s.withColor(ChatFormatting.DARK_GREEN)),
				new TextComponent(targetName).withStyle(s -> s.withColor(ChatFormatting.RED))
		);
	}
