...
public class ConfigGroupDeleteConfirmCommand extends ConfigGroupCommand {
	...
	protected ConfigGroupDeleteConfirmCommand() {
		super("delete", "confirm", false, false);
	}
	...
	protected Either<Component, PlayerConfigGroupActionError> executeCommand(
		...
		if(!"confirm".equals(inputSecondaryArgument))
			return Either.left(CONFIRMATION_FAIL_MESSAGE);
		Optional<PlayerConfigGroupActionError> result =
