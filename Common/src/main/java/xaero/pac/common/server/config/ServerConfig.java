...
public class ServerConfig {
	...
	private ServerConfig(ForgeConfigSpec.Builder builder) {
		...
		blockProtectionExceptionList = builder
			.comment("Blocks to exclude from chunk protection. Just a block ID in the list, e.g. \"minecraft:level\" allows block interaction if a claim owner's config agrees and the item in the used hand isn't blocking it. A block ID with a prefix \"force$\" allows interactions without asking the claim owner's config. Prefix \"hand$\" is the same as no prefix but enforces an empty hand requirement. Prefix \"force_hand$\" is the same as the prefix \"force$\" but enforces an empty hand requirement. Prefix \"break$\" allows breaking the block, if the claim owner's config agrees. Prefix \"force_break$\" allows breaking across the server. Add the same block multiple times to use multiple prefixes. For example [\"minecraft:lever\", \"force$minecraft:stone_button\", \"force_break$minecraft:stone_button\"]")
			.translation("gui.xaero_pac_config_block_protection_exception_empty_hand")
			.worldRestart()
			.defineListAllowEmpty(Lists.newArrayList("blockProtectionExceptionList"), () -> Lists.newArrayList("minecraft:lever", "minecraft:stone_button", "minecraft:polished_blackstone_button", "minecraft:oak_button", "minecraft:spruce_button", "minecraft:birch_button", "minecraft:jungle_button", "minecraft:acacia_button", "minecraft:dark_oak_button", "minecraft:crimson_button", "minecraft:warped_button", "force$minecraft:crafting_table"), s -> s instanceof String);
