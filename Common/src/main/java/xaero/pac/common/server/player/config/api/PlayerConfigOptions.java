...
public class PlayerConfigOptions {
	...
	/**
	 * Whether the claimed chunk protection makes an exception for blocks being affected by item enchantments.
	 */
	public static final IPlayerConfigOptionSpecAPI<String> CLAIM_EXCEPTION_BLOCKS_BY_ENCHANTMENTS;
	/**
	...
	static {
		...
		CLAIM_EXCEPTION_BLOCKS_BY_ENCHANTMENTS = PlayerConfigPlayerGroupOptionSpec.Builder.begin()
				...
				.setComment(
						...
						"such as frost walking affecting blocks by players in the group or entities owned by any player " +
						"in the group.\n"
