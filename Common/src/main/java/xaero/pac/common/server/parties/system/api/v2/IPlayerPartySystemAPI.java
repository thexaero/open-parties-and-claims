...
package xaero.pac.common.server.parties.system.api.v2;
...
public interface IPlayerPartySystemAPI<P> {
	 ...
	 *
	 * @param playerId  the UUID of the player, not null
	 * @return true, if the player is permitted to edit the party's claims config, otherwise false
	 */
	 ...
	 *
	 * @param playerId  the UUID of the player, not null
	 * @return true, if the player is permitted to create player groups, otherwise false
	 */
	boolean canCreatePartyConfigGroups(@Nonnull UUID playerId);

	/**
	 * Checks if a player is permitted to include/exclude player groups in other player groups in the
	 * party's claims config (the party owner's config).
	 *
	 * @param playerId  the UUID of the player, not null
	 * @return true, if the player is permitted to include/exclude player groups in other player groups, otherwise false
	 */
	boolean canIncludeGroupsInPartyConfigGroups(@Nonnull UUID playerId);

	/**
	 * Checks if a player is permitted to include/exclude players in player groups in the
	 * party's claims config (the party owner's config).
	 *
	 * @param playerId  the UUID of the player, not null
	 * @return true, if the player is permitted to include/exclude player groups in other player groups, otherwise false
	 ...
	 *
	 * @param party  the party the owner of which will be returned, not null
	 * @return the UUID of the party owner, null if the party has no owner (things won't work!)
	 */
	@Nullable
	UUID getOwner(@Nonnull P party);

	/**
	 * Gets the display name of a specified party.
	 *
	 * @param party  the party the display name of which will be returned, not null
	 * @return the party display name as a Component, null if the party doesn't have one
	 */
	@Nullable
	Component getName(@Nonnull P party);

	/**
	 * Gets the member count of a specified party.
	 *
	 * @param party  the party the member count of which will be returned, not null
	 * @return the member count of the party
	 */
