...
public class PartyPlayerConfigGroup extends SimpleBuiltInPlayerConfigGroup {

	public PartyPlayerConfigGroup(String id) {
	...
	public boolean isDirectlyInGroup(IPlayerConfig contextConfig, @Nullable ServerPlayer player, @Nullable UUID playerId) {
		...
		return partySystemManager.areInSameParty(configOwnerId, playerId);
	}
