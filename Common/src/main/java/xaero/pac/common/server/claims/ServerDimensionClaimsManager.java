...
public final class ServerDimensionClaimsManager extends DimensionClaimsManager<ServerPlayerClaimInfoManager, ServerRegionClaims> implements IServerDimensionClaimsManager<ServerRegionClaims> {
	...
	public ServerDimensionClaimsManager(ResourceLocation dimension, Long2ObjectMap<ServerRegionClaims> claims, ServerClaimsManager manager, boolean playerClaimsSyncAllowed) {
	...
	@Override
	protected ServerRegionClaims create(ResourceLocation dimension, int x, int z) {
