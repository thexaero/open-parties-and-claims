...
> extends IClaimsManager<PCI, WCM>, IServerClaimsManagerAPI {
	...
	@Nonnull
	public ClaimResult<C> tryToClaimTyped(@Nonnull Identifier dimension, @Nonnull UUID playerId, int subConfigIndex, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean force);
	...
	@Nonnull
	public ClaimResult<C> tryToUnclaimTyped(@Nonnull Identifier dimension, @Nonnull UUID playerId, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean force);
	...
	@Nonnull
	public ClaimResult<C> tryToForceloadTyped(@Nonnull Identifier dimension, @Nonnull UUID playerId, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean enable, boolean force);

	@Nonnull
	@Override
	@SuppressWarnings("unchecked")
	default ClaimResult<IPlayerChunkClaimAPI> tryToClaim(@Nonnull Identifier dimension, @Nonnull UUID playerId, int subConfigIndex, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean force) {
	...
	@Override
	@SuppressWarnings("unchecked")
	default ClaimResult<IPlayerChunkClaimAPI> tryToUnclaim(@Nonnull Identifier dimension, @Nonnull UUID playerId, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean force) {
	...
	@Override
	@SuppressWarnings("unchecked")
	default ClaimResult<IPlayerChunkClaimAPI> tryToForceload(@Nonnull Identifier dimension, @Nonnull UUID playerId, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean enable, boolean force) {
