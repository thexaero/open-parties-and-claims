...
public final class ServerClaimsManager extends ClaimsManager<ServerPlayerClaimInfo, ServerPlayerClaimInfoManager, ServerRegionClaims, ServerDimensionClaimsManager, ServerClaimStateHolder> implements IServerClaimsManager<PlayerChunkClaim, ServerPlayerClaimInfo, ServerDimensionClaimsManager> {
	...
	private ClaimResult<PlayerChunkClaim> tryToClaimHelper(Identifier dimension, UUID playerId, int subConfigIndex, int fromX, int fromZ, int x, int z, boolean forceLoaded, boolean replace, boolean isServer, int claimLimit) {
	...
	private ClaimResult<PlayerChunkClaim> tryToForceloadHelper(Identifier dimension, UUID id, int fromX, int fromZ, int x, int z, boolean enable, boolean replace, boolean isServer, int claimLimit, int forceloadLimit) {
		PlayerChunkClaim currentClaim = get(dimension, x, z);
