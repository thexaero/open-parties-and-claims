...
public enum PlayerConfigType {
	...
	SERVER(
			new TranslatableComponent("gui.xaero_pac_config_type_server"),
	...
	EXPIRED(
			new TranslatableComponent("gui.xaero_pac_config_type_expired"),
			null,
			true,
	...
	/** Wilderness config */
	WILDERNESS(
			new TranslatableComponent("gui.xaero_pac_config_type_wilderness"),
			null,
			true,
			PlayerSubConfigType.DIMENSION,
			"wilderness-config",
	...
	DEFAULT_PLAYER(
			new TranslatableComponent("gui.xaero_pac_config_type_default_player"),
			null,
			true,
	...
	/** A player config */
	PLAYER(
			new TranslatableComponent("gui.xaero_pac_config_type_player"),
	...
	/** Party claims config */
	PARTY_CLAIMS(
			new TranslatableComponent("gui.xaero_pac_config_type_party_claims"),
