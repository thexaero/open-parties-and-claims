...
public interface IServerClaimsManagerAPI
	 ...
	 * Use {@link #tryToClaim(Identifier, UUID, int, Identifier, int, int, int, int, boolean)} or
	 * {@link #tryToForceload(Identifier, UUID, Identifier, int, int, int, int, boolean, boolean)}
	 ...
	 * <p>
	 * It is usually a bad idea to give regular players unfiltered access to this method.
	 * Use {@link #tryToUnclaim(Identifier, UUID, Identifier, int, int, int, int, boolean)} instead
	...
	/**
	 * @deprecated Use {@link #tryToUnclaim(Identifier, UUID, Identifier, int, int, int, int, boolean)} instead
	...
	/**
	 * @deprecated Use {@link #tryToForceload(Identifier, UUID, Identifier, int, int, int, int, boolean, boolean)} instead
	...
	/**
	 * @deprecated Use {@link #tryToClaimArea(Identifier, UUID, int, Identifier, int, int, int, int, int, int, boolean, Consumer)} instead
	...
	@Deprecated
	@Nonnull
	default AreaClaimResult tryToClaimArea(@Nonnull Identifier dimension, @Nonnull UUID playerId, int subConfigIndex, int fromX, int fromZ, int left, int top, int right, int bottom, boolean replace){
	...
	/**
	 * @deprecated Use {@link #tryToUnclaimArea(Identifier, UUID, Identifier, int, int, int, int, int, int, boolean, Consumer)} instead
	...
	@Deprecated
	@Nonnull
	default AreaClaimResult tryToUnclaimArea(@Nonnull Identifier dimension, @Nonnull UUID playerId, int fromX, int fromZ, int left, int top, int right, int bottom, boolean replace){
	...
	/**
	 * @deprecated Use {@link #tryToForceloadArea(Identifier, UUID, Identifier, int, int, int, int, int, int, boolean, boolean, Consumer)} instead
	...
	@Deprecated
	@Nonnull
	default AreaClaimResult tryToForceloadArea(@Nonnull Identifier dimension, @Nonnull UUID playerId, int fromX, int fromZ, int left, int top, int right, int bottom, boolean enable, boolean replace){
	 ...
	 */
	@Nonnull
	public ClaimResult<IPlayerChunkClaimAPI> tryToClaim(@Nonnull Identifier dimension, @Nonnull UUID playerId, int subConfigIndex, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean force);
	 ...
	 */
	@Nonnull
	public ClaimResult<IPlayerChunkClaimAPI> tryToUnclaim(@Nonnull Identifier dimension, @Nonnull UUID playerId, @Nonnull Identifier fromDimension, int fromX, int fromZ, int x, int z, boolean force);
	 ...
	 * @param listener  the claiming result listener, not null
	 */
	public void tryToUnclaimArea(@Nonnull Identifier dimension, @Nonnull UUID playerId, @Nonnull Identifier fromDimension, int fromX, int fromZ, int left, int top, int right, int bottom, boolean force, @Nonnull Consumer<AreaClaimResult> listener);
	 ...
	 * @param listener  the claiming result listener, not null
	 */
	public void tryToForceloadArea(@Nonnull Identifier dimension, @Nonnull UUID playerId, @Nonnull Identifier fromDimension, int fromX, int fromZ, int left, int top, int right, int bottom, boolean enable, boolean force, @Nonnull Consumer<AreaClaimResult> listener);
