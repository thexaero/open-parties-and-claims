...
public class PlayerConfigConstants {
	...
	public static final Component ON_COMPONENT = new TranslatableComponent("gui.xaero_pac_ui_on");
	public static final Component OFF_COMPONENT = new TranslatableComponent("gui.xaero_pac_ui_off");
	...
	public static final Component UNKNOWN_PLAYER =
			new TranslatableComponent("gui.xaero_pac_player_config_player_groups_unknown_player");
	public static final Component OPTION_NOT_DIRECTLY_CONFIGURABLE =
			new TranslatableComponent("gui.xaero_pac_config_option_not_directly_configurable");
