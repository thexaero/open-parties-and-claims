...
public class OPACOptionsDisplayFabric extends OPACOptionsDisplay<OPACOptionsFabric, ListEntry, TextListEntry, TriStateListEntry, BetterNumberBoxListEntryFabric, TriState> implements OptionDisplay {

	public static OPACOptionsDisplayFabric create(Role role, SelectionList<ListEntry> ignored) {
		OPACOptionsDisplayFabric instance = new OPACOptionsDisplayFabric();
		OPACOptionsFabric options = role.getNonNullOption(OPACOptionsFabric.SERIALIZER);
	...
	public boolean save(Role role) {
		OPACOptionsFabric options = new OPACOptionsFabric();
	...
	@Override
	protected BetterNumberBoxListEntryFabric betterNumberBoxListEntry(int amount, boolean decimals, Component component, Component tooltip) {
		return new BetterNumberBoxListEntryFabric(amount, decimals, component, tooltip);
	}
