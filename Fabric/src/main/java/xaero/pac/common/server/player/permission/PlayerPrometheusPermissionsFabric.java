...
public class PlayerPrometheusPermissionsFabric implements IPlayerPermissionSystemAPI {

	@Nonnull
	@Override
	public OptionalInt getIntPermission(@Nonnull ServerPlayer player, @Nonnull IPermissionNodeAPI node) {
		OPACOptionsFabric options = RoleApi.API.getOption(player, OPACOptionsFabric.SERIALIZER);
