...
public class MappingHelperFabric implements IMappingHelper {
	@Override
	public String fixFabricFieldMapping(Class<?> clazz, String name, String descriptor) {
	...
	@Override
	public String fixFabricMethodMapping(Class<?> clazz, String name, String descriptor) {
		MappingResolver mappingResolver = FabricLoader.getInstance().getMappingResolver();
		String owner = mappingResolver.unmapClassName("intermediary", clazz.getName());
